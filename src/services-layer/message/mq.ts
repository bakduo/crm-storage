...
import { loggerApp } from "../../configure";
            ...
            return await this.channel.consume(
                ...
                (message:unknown) => {
                  ...
                  if (msg) {
                    ...
                    /*
            rc/services-layer/message/mq.ts:35:11 - error TS2416: Property 'recieveMessage' in type 'MQservice' is not assignable to the same property in base type 'IMessageAsync'.
            Type '(callback: Function) => Promise<unknown>' is not assignable to type '(callback: Function) => Promise<Consume>'.
                Type 'Promise<unknown>' is not assignable to type 'Promise<Consume>'.
                Type 'unknown' is not assignable to type 'Consume'.
