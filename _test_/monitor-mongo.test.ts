...
import {ItemMonitorMongo} from '../src/data-layer/dao/monitor.mongo';
...
const dao = new ItemMonitorMongo();

describe('Test MongoDAO MonitorItem UNIT',async () => {

    before(async function(){

        console.log("###############BEGIN TEST MongoDAO MonitorItem#################");
    ...
    after(async () => {
        console.log("###############AFTER TEST MongoDAO MonitorItem#################");
        await dao.deleteAll();
    });

    describe('Operaciones sobre MongoDAO MonitorItem', async () => {
